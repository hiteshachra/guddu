...
//             let totalFiles = [];
//             let counter = 0;
//             let dragbox = $(`<div class="imageuploadify well"><div class="imageuploadify-overlay"><i class="fa fa-picture-o"></i></div><div class="imageuploadify-images-list text-center pt-2"><!--<i class="fas fa-cloud-upload-alt">--></i><span class='imageuploadify-message'>Drag & Drop Your Images Or Vidoes</span><button type="button"class="btn btn-default">or select file to upload</button></div></div>`);
...
//                 let container = $(`<div class='imageuploadify-container'><button type='button'class='btn btn-danger fas fa-times-circle'></button><div class='imageuploadify-details'><span>${file.name}</span><span>${file.type}</span><span>${file.size}</span></div></div>`);
