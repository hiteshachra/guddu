                  ...
                  <div class="sidebar-body">
                    ...
                    <ul class="list-unstyled chat-contact-list py-2 mb-0" id="chat-list">
                      ...
                      <li class="chat-contact-list-item chat-list-item-0 " style="margin-block: unset;padding-block: unset;align-items: flex-start;">
                        ...
                        <span>{{$lead->source_description}}</span>
                      </li>
                      ...
                      <li class="chat-contact-list-item chat-list-item-0" style="margin-block: unset;padding-block: unset;align-items: flex-start;">
                        ...
                        <span>{{$lead->assigned_date}}</span>
                      </li>

                      <li class="chat-contact-list-item chat-list-item-0" style="margin-block: unset;padding-block: unset;align-items: flex-start;">
                        <span class="h6 me-1">Status :</span>
                        <span class="badge bg-label-success">{{$lead->status}}</span>
                      </li>
                    ...
                    <div class="chat-history-header border-bottom">
                      <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex overflow-hidden align-items-center">
                          ...
                          <div class="chat-contact-info flex-grow-1 ms-4">
                            <h6 class="m-0 fw-normal">{{ $lead->user_name }}</h6>
                            <small class="user-status text-body">{{ $lead->company_name }}</small>
                          </div>
                        </div>
                      ...
                      <div class="chat-history-body" id="chat-container">
                          <ul class="list-unstyled chat-history" id="chat-history">
                            @include('CRM.leads.partials.follow-up-messages') 
                          </ul>
                      </div>

                      <!-- Chat message form -->
                      <div class="chat-history-footer shadow-xs">
                          <form class="form-send-message" action="{{route('lead_follow_up',[$lead->id])}}" method="POST" enctype="multipart/form-data">
                              @csrf
                              <div class=" d-flex justify-content-between align-items-center">
                              ...
                              <div class="d-flex justify-content-between align-items-center">
                                <select class="form-select message-input border-0 shadow-none" data-style="btn-default" id="follow_up_type" name="follow_up_type" aria-label="Select Type" required>
                                    <option value="" @selected(old('follow_up_type') == '') disabled>Select Followup Type</option>
                                    <option value="Call" @selected(old('follow_up_type') == 'Call')>Call</option>
                                    ...
                                    <option value="Note" @selected(old('follow_up_type') == 'Note')>Note</option>
                                    <option value="Visit" @selected(old('follow_up_type') == 'Visit')>Visit</option>
  ...
  <script>
    ...
    chatContainer.addEventListener('scroll', function () {
        if (chatContainer.scrollTop === 0 && !loading) {
            ...
            fetch(`/follow-up/{{ $lead->id }}?before_id=${beforeId}`, {
                headers: {
