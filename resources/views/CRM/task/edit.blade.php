    ...
    <div class="row mb-6 gy-6">
        ...
        <div class="col-xl">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('edit_task',[$task->id]) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-6">
                                    ...
                                    <select class="form-select" id="employee" name="employee"
                                        ...
                                        @foreach ($employees as $employee)
                                            <option value="{{$employee->id}}" @selected(old('employee',$task->user_id) == $employee->id)>{{$employee->name}}</option>
                                        @endforeach
                                    </select>
                                    @error('employee')
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" class="form-control" id="title" name="title"
                                            placeholder="Titile" aria-label="Titile" required value="{{ old('title',$task->title) }}"
                            ...
                            <div class="col-sm-4">
                                <div class="mb-6">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input class="form-control" type="date" value="{{ old('due_date',$task->due_date) }}"
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="input-group">
                                        <textarea id="remark" name="remark" class="form-control" placeholder="Remark"
                                            aria-label="Remark" aria-describedby="remark">{{ old('remark',$task->remark) }}</textarea>
                                    </div>
                                    @error('remark')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="input-group">
                                        <textarea id="description" name="description" class="form-control" placeholder="Description"
                                            aria-label="Description" aria-describedby="Description">{{ old('description',$task->description) }}</textarea>
                                    </div>
                                    @error('description')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
