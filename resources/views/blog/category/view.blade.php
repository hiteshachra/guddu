...
@section('content')
    ...
    <div class="card">
        <div class="card-header border-bottom d-flex justify-content-between">
            ...
            <a href="{{ route('blog_categories_create') }}" class="btn add-new btn-primary"><span><span
...
<script>
    $(document).ready(function() {
        ...
        const table1 = initializeDataTable("#data-table", "{{ route('blog_categories') }}", Columns, function (d) {
    ...
    function deleteCategory(categoryId) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let url = "{{ route('blog_categories_update_status', ':id') }}".replace(':id', categoryId);
