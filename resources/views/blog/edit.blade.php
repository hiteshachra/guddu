    ...
    <div class="row mb-6 gy-6">
        ...
        <div class="col-xl">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="editBlog" action="{{ route('blog_update', [$blog->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-sm-3">
                                <div class="mb-6">
                                    ...
                                    <select class="selectpicker w-100" data-style="btn-default" id="status" name="status" data-placeholder="Select Status" required>
                                        ...
                                        <option value="Schedule" @selected(old('status', $blog->status) == 'Schedule')>Schedule</option>
                                        <option value="Publish" @selected(old('status', $blog->status) == 'Publish')>Publish</option>
                            ...
                            <div class="col-sm-3" id="div_schedule_date"  @if (old('status', $blog->status) == 'Schedule') @else style="display: none;" @endif>
                                <div class="mb-6">
                                    <label for="schedule_date" class="form-label">Schedule Date<span class="text-danger">*</span></label>
                                    <input class="form-control" type="datetime-local" id="schedule_date" name="schedule_date" value="{{ old('schedule_date', ($blog->publish_datetime ?? now())) }}" />
                                </div>
                                @error('schedule_date')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="col-sm-12">
                                <div class="mb-6">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" class="form-control" id="title" name="title" placeholder="First Course" aria-label="First Course" value="{{ old('title', $blog->title) }}" aria-describedby="title2" />
                                    </div>
                                    @error('title')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
