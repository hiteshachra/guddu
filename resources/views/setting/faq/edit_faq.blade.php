...
<div class="row mb-6 gy-6">
    <div class="col-xl">
        <div class="card">
            ...
            <div class="card-body">
                <form id="addContent" action="{{ route('update_faq',[$faq->id]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-sm-10 mb-6">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control" id="question" name="question" placeholder="Enter question" aria-label="Enter question" value="{{ old('question', $faq->question) }}" />
                                </div>
                                @error('question')
                        ...
                        <div class="col-sm-2 mb-6">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="number" class="form-control" id="order_by" name="order_by" placeholder="Enter order by" aria-label="Enter order by" value="{{ old('order_by', $faq->order_by) }}" />
                                </div>
                                @error('order_by')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="col-sm-12">
                            <div class="mb-6">
                                ...
                                <div id="full-editor"> {!! old('answer', $faq->answer) !!} </div>
                                @error('answer')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
