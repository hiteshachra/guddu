...
@section('content')
    ...
    <div class="card">
        <div class="card-header border-bottom d-flex justify-content-between">
            ...
            <a href="{{ route('add_faq') }}" class="btn add-new btn-primary"><span><span
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            const table1 = initializeDataTable("#data-table", "{{ route('faq_list') }}", Columns, function (d) {
                d.status = $('#status').val();
            });
        ...
        function deleteFaq(Id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    let url = "{{ route('delete_faq', ':id') }}".replace(':id', Id);
        ...
        function changeFaq(Id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    let url = "{{ route('status_faq', ':id') }}".replace(':id', Id);
