        ...
        <div class="col-xl">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Edir Steps</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('edit_steps',[$step->id]) }}" method="POST">
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" class="form-control" id="title" name="title"
                                            placeholder="Title" aria-label="Title" required value="{{ old('title',$step->title) }}"
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" class="form-control" id="icon"
                                            ...
                                            aria-label="Icon" required value="{{ old('icon',$step->icon) }}"
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" class="form-control" id="order"
                                            ...
                                            aria-label="Order" required value="{{ old('order',$step->order) }}"
