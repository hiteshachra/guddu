...
@section('content')
    ...
    <div class="card">
        <div class="card-header border-bottom d-flex justify-content-between">
            ...
            <a href="{{ route('video_create') }}" class="btn add-new btn-primary"><span><span
...
<script>
    $(document).ready(function() {
        ...
        const table1 = initializeDataTable("#data-table", "{{ route('video_list') }}", Columns, function (d) {
    ...
    function deleteCategory(Id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let url = "{{ route('video_update_status', ':id') }}".replace(':id', Id);
