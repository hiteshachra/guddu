...
var options = {
    ...
    "handler": function (response){
        ...
        document.getElementById('txt_amount').value = "{{$form_data['amount']}}";
		document.getElementById('receiptId').value = "{{$response['receiptId']}}";
...
<!-- This form is hidden -->
<form action="{{url('/payment-completeuser-addmoneywall')}}" method="POST" hidden>
        <input type="hidden" value="{{csrf_token()}}" name="_token" /> 
        <input type="text" class="form-control" id="rzp_paymentid"  name="rzp_paymentid">
        <input type="text" class="form-control" id="rzp_orderid" name="rzp_orderid">
        <input type="text" class="form-control" id="rzp_signature" name="rzp_signature">
        <input type="text" class="form-control" id="txt_amount" name="txt_amount">
