                  ...
                  <div class="sidebar-body">
                    ...
                    <ul class="list-unstyled chat-contact-list py-2 mb-0" id="chat-list">
                      <li class="chat-contact-list-item chat-list-item-0" style="margin-block: unset;padding-block: unset;align-items: flex-start;">
                        ...
                        <span><?php echo e($data->code); ?></span>
                      </li>

                      <li class="chat-contact-list-item chat-list-item-0" style="margin-block: unset;padding-block: unset;align-items: flex-start;">
                        <span class="h6 me-1">Request For :</span>
                        <span><?php echo e($data->for); ?></span>
                      </li>
                      ...
                      <li class="chat-contact-list-item chat-list-item-0" style="margin-block: unset;padding-block: unset;align-items: flex-start;">
                        ...
                        <span><?php echo e($data->user->phone_number); ?></span>
                      </li>

                      <li class="chat-contact-list-item chat-list-item-0" style="margin-block: unset;padding-block: unset;align-items: flex-start;">
                        <span class="h6 me-1">Subject :</span>
                        <span><?php echo e($data->subject); ?></span>
                      </li>
                      ...
                      <li class="chat-contact-list-item chat-list-item-0" style="margin-block: unset;padding-block: unset;align-items: flex-start;">
                        ...
                        <span><?php echo e($data->assigned_date); ?></span>
                      </li>

                      <li class="chat-contact-list-item chat-list-item-0" style="margin-block: unset;padding-block: unset;align-items: flex-start;">
                        <span class="h6 me-1">Status :</span>
                        <span class="badge bg-label-success"><?php echo e($data->status); ?></span>
                      </li>
                    ...
                    <div class="chat-history-header border-bottom">
                      <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex overflow-hidden align-items-center">
                          ...
                          <div class="chat-contact-info flex-grow-1 ms-4">
                            <h6 class="m-0 fw-normal"><?php echo e($data->user_name); ?></h6>
                            <small class="user-status text-body"><?php echo e($data->company_name); ?></small>
                          </div>
                        </div>
                      ...
                      <div class="chat-history-body" id="chat-container">
                          <ul class="list-unstyled chat-history" id="chat-history">
                            <?php echo $__env->make('support.partials.messages-list', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?> 
                          </ul>
                      </div>
                      ...
                      <div class="chat-history-footer shadow-xs" style="margin-top:  2.2rem;">
                          <form class="form-send-message" action="<?php echo e(route('store_reply_ticket',[$data->id])); ?>" method="POST" enctype="multipart/form-data">
                              <?php echo csrf_field(); ?>
                              <div class=" d-flex justify-content-between align-items-center">
  ...
  <script>
    ...
    chatContainer.addEventListener('scroll', function () {
        if (chatContainer.scrollTop === 0 && !loading) {
            ...
            fetch(`/follow-up/<?php echo e($data->id); ?>?before_id=${beforeId}`, {
                headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\sgitsss\ignitingbusiness\resources\views/support/messages.blade.php ENDPATH**/ ?>