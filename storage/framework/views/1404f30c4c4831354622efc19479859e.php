...
<!-- Content -->
<div class="container-xxl flex-grow-1 container-p-y" style="margin-top:65px">
    <!-- Header -->
    <div class="row">
    <div class="col-12">
        <div class="card mb-6">
        ...
        <div class="user-profile-header d-flex flex-column flex-lg-row text-sm-start text-center mb-5">
            ...
            <div
                ...
                <i class="icon-base ti tabler-user-edit icon-xs me-2"></i>Edit
                </a>
            </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\sgitsss\ignitingbusiness\resources\views/user/profile.blade.php ENDPATH**/ ?>