...
<div class="card">
    <div class="card-header border-bottom d-flex justify-content-between">
        ...
        <a href="<?php echo e(route('add_task')); ?>" class="btn add-new btn-primary"><span><span
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body" id="statusBody">
                    <form action="<?php echo e(route('status_task')); ?>" method="post">
                        <?php echo csrf_field(); ?>
...
<?php $__env->startPush('scripts'); ?>
    <script>    
        $(document).ready(function() {
            ...
            const table1 = initializeDataTable('#data-table', '<?php echo e(route('task_list')); ?>', Columns, function (d) {
                d.status = $('#status').val();
            });
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\sgitsss\ignitingbusiness\resources\views/CRM/task/view.blade.php ENDPATH**/ ?>