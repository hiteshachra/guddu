<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-header border-bottom d-flex justify-content-between">
            ...
            <a href="<?php echo e(route('add_step')); ?>" class="btn add-new btn-primary"><span><span
        ...
        $(document).ready(function() {
            ...
            if (datatable) {
                ...
                table = new DataTable(datatable, {
                    ...
                    serverSide: true,
                    ajax: {
                        url: '<?php echo e(route('steps_list')); ?>',
                    },
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'DT_RowIndex',
       ...
       function deleteStep(stepId) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    let url = "<?php echo e(route('status_steps', ':id')); ?>".replace(':id', stepId);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\sgitsss\ignitingbusiness\resources\views/setting/steps/view.blade.php ENDPATH**/ ?>