<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-header border-bottom d-flex justify-content-between">
            <h5 class="card-title mb-0"><?php echo e($status); ?> Tickets</h5>
            <a href="<?php echo e(route('create_ticket')); ?>" class="btn add-new btn-primary">
                <span>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body" id="assignModalBody">
                    <form action="<?php echo e(route('assign_employee_ticket')); ?>" method="post">
                        <?php echo csrf_field(); ?>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        $(document).ready(function() {
            ...
            const table1 = initializeDataTable("#data-table", "<?php echo e(route('ticket_list', [$status])); ?>", Columns, function (d) {
                d.status = $('#status').val();
            });
        ...
        function changeStatus(fileId){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    let url = "<?php echo e(route('status_support', ':id')); ?>".replace(':id', fileId);
        ...
        function deleteFile(fileId) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    let url = "<?php echo e(route('delete_user_document', ':id')); ?>".replace(':id', fileId);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\sgitsss\ignitingbusiness\resources\views/support/view.blade.php ENDPATH**/ ?>