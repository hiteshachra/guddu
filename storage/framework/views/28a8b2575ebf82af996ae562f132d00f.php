    ...
    <div class="row mb-6 gy-6">
        ...
        <div class="col-xl">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('edit_loan',[$loan->id])); ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-6">
                                    ...
                                    <select class="form-select" id="user" name="user" aria-label="Select user"
                                        ...
                                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($user->id); ?>" <?php if(old('user',$loan->user_id) == $user->id): echo 'selected'; endif; ?>>
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" class="form-control" id="amount" name="amount"
                                            placeholder="Amount" aria-label="Amount" required value="<?php echo e(old('amount',$loan->amount)); ?>"
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" class="form-control" id="commission_amount"
                                            ...
                                            aria-label="Commission Amount" required value="<?php echo e(old('commission_amount',$loan->commission_amount)); ?>"
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" class="form-control" id="trans_number" name="trans_number"
                                            ...
                                            value="<?php echo e(old('trans_number',$loan->trans_number)); ?>" aria-describedby="trans_number2" />
                                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\sgitsss\ignitingbusiness\resources\views/loans/edit.blade.php ENDPATH**/ ?>