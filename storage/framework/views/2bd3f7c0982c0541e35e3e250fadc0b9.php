<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-header border-bottom d-flex justify-content-between">
            ...
            <a href="<?php echo e(route('blog_categories_create')); ?>" class="btn add-new btn-primary"><span><span
...
<script>
    $(document).ready(function() {
        ...
        const table1 = initializeDataTable("#data-table", "<?php echo e(route('blog_categories')); ?>", Columns, function (d) {
    ...
    function deleteCategory(categoryId) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let url = "<?php echo e(route('blog_categories_update_status', ':id')); ?>".replace(':id', categoryId);

                $.ajax({
                    url: url,
                    method: 'GET',
                    success: function(response) {
                        Swal.fire('Change!', 'Category status changed.', 'success').then(() => {
                            location.reload();
                        });
                    },
                    error: function(xhr) {
                        Swal.fire('Error!', 'Failed to change status Category.', 'error');
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\sgitsss\ignitingbusiness\resources\views/blog/category/view.blade.php ENDPATH**/ ?>