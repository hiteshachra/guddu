<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-header border-bottom d-flex justify-content-between">
            ...
            <a href="<?php echo e(route('add_business_category')); ?>" class="btn add-new btn-primary"><span><span
...
<script>
    $(document).ready(function() {
        ...
        const table1 = initializeDataTable('#data-table', '<?php echo e(route('business_categories_list')); ?>', businessColumns, function (d) {
    ...
    function deleteCategory(categoryId) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let url = "<?php echo e(route('status_business_category', ':id')); ?>".replace(':id', categoryId);
    ...
    function openModal(type, value) {
        ...
        if (type === 'image') {
            content = `<img src="<?php echo e(asset('categories_images')); ?>/${value}" alt="Image" class="img-fluid">`;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\sgitsss\ignitingbusiness\resources\views/courses/business_category/view.blade.php ENDPATH**/ ?>