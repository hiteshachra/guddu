            ...
            $(document).ready(function() {
                ...
                if (datatable) {
                    ...
                    table = new DataTable(datatable, {
                        ...
                        serverSide: true,
                        ajax: {
                            url: '<?php echo e(route('commission')); ?>',
                        },
                        columns: [{
                                data: 'DT_RowIndex',
                                name: 'DT_RowIndex',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\sgitsss\ignitingbusiness\resources\views/commission/view.blade.php ENDPATH**/ ?>