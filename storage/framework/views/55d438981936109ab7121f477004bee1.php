<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-header border-bottom d-flex justify-content-between">
            ...
            <a href="<?php echo e(route('add_user_document')); ?>" class="btn add-new btn-primary"><span><span
...
<?php $__env->startPush('scripts'); ?>
    <script>
        $(document).ready(function() {
            ...
            const table1 = initializeDataTable("#data-table", "<?php echo e(route('user_document_list')); ?>", Columns, function (d) {
                d.status = $('#status').val();
            });
        ...
        function changeStatus(fileId){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    let url = "<?php echo e(route('status_user_document', ':id')); ?>".replace(':id', fileId);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\sgitsss\ignitingbusiness\resources\views/Document/User/view.blade.php ENDPATH**/ ?>