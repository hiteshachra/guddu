<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-header border-bottom d-flex justify-content-between">
            ...
            <a href="<?php echo e(route('video_create')); ?>" class="btn add-new btn-primary"><span><span
                        class="d-flex align-items-center gap-2"><i class="icon-base ti tabler-plus icon-xs"></i> <span
                            class="d-none d-sm-inline-block">Add Video</span></span></span></a>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        const table1 = initializeDataTable("#data-table", "<?php echo e(route('video_list')); ?>", Columns, function (d) {
    ...
    function deleteCategory(Id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let url = "<?php echo e(route('video_update_status', ':id')); ?>".replace(':id', Id);

                $.ajax({
                    url: url,
                    method: 'GET',
                    success: function(response) {
                        Swal.fire('Change!', 'Video status changed.', 'success').then(() => {
                            location.reload();
                        });
                    },
                    error: function(xhr) {
                        Swal.fire('Error!', 'Failed to change status Video.', 'error');
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\sgitsss\ignitingbusiness\resources\views/setting/video/view.blade.php ENDPATH**/ ?>