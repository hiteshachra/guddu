<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-header border-bottom d-flex justify-content-between">
            ...
            <a href="<?php echo e(route('image_create')); ?>" class="btn add-new btn-primary"><span><span
...
<script>
    $(document).ready(function() {
        ...
        const table1 = initializeDataTable("#data-table", "<?php echo e(route('image_list')); ?>", Columns, function (d) {
    ...
    function deleteImage(Id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let url = "<?php echo e(route('image_update_status', ':id')); ?>".replace(':id', Id);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\sgitsss\ignitingbusiness\resources\views/setting/image/view.blade.php ENDPATH**/ ?>