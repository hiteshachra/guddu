...
<div class="row mb-6 gy-6">
    <div class="col-xl">
        <div class="card">
            ...
            <div class="card-body">
                <form id="addContent" action="<?php echo e(route('faq_store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        ...
                        <div class="col-sm-10 mb-6">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control" id="question" name="question" placeholder="Enter question" aria-label="Enter question" value="<?php echo e(old('question')); ?>" />
                                </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-sm-2 mb-6">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="number" class="form-control" id="order_by" name="order_by" placeholder="Enter order by" aria-label="Enter order by" value="<?php echo e(old('order_by')); ?>" />
                                </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-sm-12">
                            <div class="mb-6">
                                ...
                                <div id="full-editor"> <?php echo old('answer'); ?> </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\sgitsss\ignitingbusiness\resources\views/setting/faq/add_faq.blade.php ENDPATH**/ ?>