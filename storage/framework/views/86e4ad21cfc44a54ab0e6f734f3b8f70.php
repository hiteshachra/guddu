    ...
    <div class="hero-content position-relative overflow-hidden">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".25s">
                        ...
                        <div class="banner-form bg-white border mb-3">
                            ...
                            <img src="<?php echo e(asset('front/assets/img/bg/bg-06.svg')); ?>" alt="img" class="shape-06 round-animate">
                        </div>
                        ...
                        <div class="d-flex align-items-center flex-wrap banner-info">
                            <div class="d-flex align-items-center me-4 mt-4">
                                <img src="<?php echo e(asset('front/assets/img/icons/success-01.svg')); ?>" alt="icon">
                                <div class="ms-2">
                                    <h6>215,292 +</h6>
                            ...
                            <div class="d-flex align-items-center me-4 mt-4">
                                <img src="<?php echo e(asset('front/assets/img/icons/success-02.svg')); ?>" alt="icon">
                                <div class="ms-2">
                                    <h6>90,000+</h6>
                            ...
                            <div class="d-flex align-items-center me-4 mt-4">
                                <img src="<?php echo e(asset('front/assets/img/icons/success-03.svg')); ?>" alt="icon">
                                <div class="ms-2">
                                    <h6>2,390,968 </h6>
                ...
                <div class="banner-img wow fadeInUp" data-wow-duration="1s" data-wow-delay=".25s">
                    <img src="<?php echo e(asset('front/assets/img/banner.png')); ?>" alt="img" class="img-fluid animation-float">
                </div>
            </div>
        </div>
        <div class="hero-image">
            ...
            <div class="d-inline-flex bg-white p-2 rounded align-items-center shape-02 floating-x">
                <span class="me-2"><img src="<?php echo e(asset('front/assets/img/icons/tick-banner.svg')); ?>" alt=""></span>
                <p class="fs-12 text-dark mb-0">300 Booking Completed</p>
                <i class="border-edge"></i>
            </div>
            <img src="<?php echo e(asset('front/assets/img/bg/bg-03.svg')); ?>" alt="img" class="shape-03">
            <img src="<?php echo e(asset('front/assets/img/bg/bg-04.svg')); ?>" alt="img" class="shape-04">
            <img src="<?php echo e(asset('front/assets/img/bg/bg-05.svg')); ?>" alt="img" class="shape-05">
        </div>
    </div>
</section>
<!-- /Hero Section -->
    ...
    <div class="container">
        ...
        <div
            ...
            <div class="col d-flex">
                <div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
                    <div class="mx-auto mb-3">
                        <img src="<?php echo e(asset('front/assets/img/icons/category-01.svg')); ?>" class="img-fluid" alt="img">
                    </div>
            ...
            <div class="col d-flex">
                <div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
                    <div class="mx-auto mb-3">
                        <img src="<?php echo e(asset('front/assets/img/icons/category-02.svg')); ?>" class="img-fluid" alt="img">
                    </div>
            ...
            <div class="col d-flex">
                <div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
                    <div class="mx-auto mb-3">
                        <img src="<?php echo e(asset('front/assets/img/icons/category-13.svg')); ?>" class="img-fluid" alt="img">
                    </div>
            ...
            <div class="col d-flex">
                <div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
                    <div class="mx-auto mb-3">
                        <img src="<?php echo e(asset('front/assets/img/icons/category-04.svg')); ?>" class="img-fluid" alt="img">
                    </div>
            ...
            <div class="col d-flex">
                <div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
                    <div class="mx-auto mb-3">
                        <img src="<?php echo e(asset('front/assets/img/icons/category-05.svg')); ?>" class="img-fluid" alt="img">
                    </div>
            ...
            <div class="col d-flex">
                <div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
                    <div class="mx-auto mb-3">
                        <img src="<?php echo e(asset('front/assets/img/icons/category-06.svg')); ?>" class="img-fluid" alt="img">
                    </div>
            ...
            <div class="col d-flex">
                <div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
                    <div class="mx-auto mb-3">
                        <img src="<?php echo e(asset('front/assets/img/icons/category-07.svg')); ?>" class="img-fluid" alt="img">
                    </div>
            ...
            <div class="col d-flex">
                <div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
                    <div class="mx-auto mb-3">
                        <img src="<?php echo e(asset('front/assets/img/icons/category-08.svg')); ?>" class="img-fluid" alt="img">
                    </div>
            ...
            <div class="col d-flex">
                <div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
                    <div class="mx-auto mb-3">
                        <img src="<?php echo e(asset('front/assets/img/icons/category-09.svg')); ?>" class="img-fluid" alt="img">
                    </div>
            ...
            <div class="col d-flex">
                <div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
                    <div class="mx-auto mb-3">
                        <img src="<?php echo e(asset('front/assets/img/icons/category-10.svg')); ?>" class="img-fluid" alt="img">
                    </div>
            ...
            <div class="col d-flex">
                <div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
                    <div class="mx-auto mb-3">
                        <img src="<?php echo e(asset('front/assets/img/icons/category-11.svg')); ?>" class="img-fluid" alt="img">
                    </div>
            ...
            <div class="col d-flex">
                <div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
                    <div class="mx-auto mb-3">
                        <img src="<?php echo e(asset('front/assets/img/icons/category-12.svg')); ?>" class="img-fluid" alt="img">
                    </div>
                    ...
                    <div class="img-slider owl-carousel nav-center">
                        <div class="slide-images">
                            <a href="service-details.html">
                                <img src="<?php echo e(asset('front/assets/img/services/service-01.jpg')); ?>" class="img-fluid" alt="img">
                            </a>
                        </div>
                        <div class="slide-images">
                            <a href="service-details.html">
                                <img src="<?php echo e(asset('front/assets/img/services/service-02.jpg')); ?>" class="img-fluid" alt="img">
                            </a>
                        </div>
                        <div class="slide-images">
                            <a href="service-details.html">
                                <img src="<?php echo e(asset('front/assets/img/services/service-03.jpg')); ?>" class="img-fluid" alt="img">
                            </a>
                        </div>
                    </div>
            ...
            <div class="service-item wow fadeInUp" data-wow-delay="0.2s">
                <div class="service-img">
                    <div class="img-slider owl-carousel nav-center">
                        <div class="slide-images">
                            <a href="service-details.html">
                                <img src="<?php echo e(asset('front/assets/img/services/service-04.jpg')); ?>" class="img-fluid" alt="img">
                            </a>
                        </div>
                        <div class="slide-images">
                            <a href="service-details.html">
                                <img src="<?php echo e(asset('front/assets/img/services/service-05.jpg')); ?>" class="img-fluid" alt="img">
                            </a>
                        </div>
                        <div class="slide-images">
                            <a href="service-details.html">
                                <img src="<?php echo e(asset('front/assets/img/services/service-06.jpg')); ?>" class="img-fluid" alt="img">
                            </a>
                        </div>
                    </div>
                    <div class="trend-icon">
            ...
            <div class="service-item wow fadeInUp" data-wow-delay="0.2s">
                <div class="service-img">
                    <div class="img-slider owl-carousel nav-center">
                        <div class="slide-images">
                            <a href="service-details.html">
                                <img src="<?php echo e(asset('front/assets/img/services/service-07.jpg')); ?>" class="img-fluid" alt="img">
                            </a>
                        </div>
                        <div class="slide-images">
                            <a href="service-details.html">
                                <img src="<?php echo e(asset('front/assets/img/services/service-08.jpg')); ?>" class="img-fluid" alt="img">
                            </a>
                        </div>
                        <div class="slide-images">
                            <a href="service-details.html">
                                <img src="<?php echo e(asset('front/assets/img/services/service-09.jpg')); ?>" class="img-fluid" alt="img">
                            </a>
                        </div>
                    </div>
                    <div class="fav-item">
            ...
            <div class="service-item wow fadeInUp" data-wow-delay="0.2s">
                <div class="service-img">
                    <div class="img-slider owl-carousel nav-center">
                        <div class="slide-images">
                            <a href="service-details.html">
                                <img src="<?php echo e(asset('front/assets/img/services/service-10.jpg')); ?>" class="img-fluid" alt="img">
                            </a>
                        </div>
                        <div class="slide-images">
                            <a href="service-details.html">
                                <img src="<?php echo e(asset('front/assets/img/services/service-11.jpg')); ?>" class="img-fluid" alt="img">
                            </a>
                        </div>
                        <div class="slide-images">
                            <a href="service-details.html">
                                <img src="<?php echo e(asset('front/assets/img/services/service-12.jpg')); ?>" class="img-fluid" alt="img">
                            </a>
                        </div>
                    </div>
                    <div class="fav-item">
            ...
            <div class="service-item wow fadeInUp" data-wow-delay="0.2s">
                <div class="service-img">
                    <div class="img-slider owl-carousel nav-center">
                        <div class="slide-images">
                            <a href="service-details.html">
                                <img src="<?php echo e(asset('front/assets/img/services/service-16.jpg')); ?>" class="img-fluid" alt="img">
                            </a>
                        </div>
                        <div class="slide-images">
                            <a href="service-details.html">
                                <img src="<?php echo e(asset('front/assets/img/services/service-17.jpg')); ?>" class="img-fluid" alt="img">
                            </a>
                        </div>
                        <div class="slide-images">
                            <a href="service-details.html">
                                <img src="<?php echo e(asset('front/assets/img/services/service-18.jpg')); ?>" class="img-fluid" alt="img">
                            </a>
                        </div>
                    </div>
                    <div class="fav-item">
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="0.2s">
                        <div class="service-img">
                            <div class="img-slider owl-carousel nav-center">
                                <div class="slide-images">
                                    <a href="service-details.html">
                                        <img src="<?php echo e(asset('front/assets/img/services/service-19.jpg')); ?>" class="img-fluid" alt="img">
                                    </a>
                                </div>
                                <div class="slide-images">
                                    <a href="service-details.html">
                                ...
                                <div class="slide-images">
                                    <a href="service-details.html">
                                        <img src="<?php echo e(asset('front/assets/img/services/service-15.jpg')); ?>" class="img-fluid" alt="img">
                                    </a>
                                </div>
                            </div>
                            <div class="fav-item d-flex align-items-center justify-content-between w-100">
                                <a href="javascript:void(0);" class="avatar avatar-md">
                                    <img src="<?php echo e(asset('front/assets/img/profiles/avatar-02.jpg')); ?>" class="rounded-circle" alt="User">
                                </a>
                                <a href="javascript:void(0);" class="fav-icon">
                                    <i class="ti ti-heart"></i>
                                </a>
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="0.2s">
                        <div class="service-img">
                            <div class="img-slider owl-carousel nav-center">
                                <div class="slide-images">
                                    <a href="service-details.html">
                                        <img src="<?php echo e(asset('front/assets/img/services/service-20.jpg')); ?>" class="img-fluid" alt="img">
                                    </a>
                                </div>
                                <div class="slide-images">
                                    <a href="service-details.html">
                            ...
                            <div class="fav-item d-flex align-items-center justify-content-between w-100">
                                <a href="javascript:void(0);" class="avatar avatar-md">
                                    <img src="<?php echo e(asset('front/assets/img/profiles/avatar-03.jpg')); ?>" class="rounded-circle" alt="User">
                                </a>
                                <a href="javascript:void(0);" class="fav-icon">
                                    <i class="ti ti-heart"></i>
                                </a>
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="0.2s">
                        <div class="service-img">
                            <div class="img-slider owl-carousel nav-center">
                                <div class="slide-images">
                                    <a href="service-details.html">
                                        <img src="<?php echo e(asset('front/assets/img/services/service-21.jpg')); ?>" class="img-fluid" alt="img">
                                    </a>
                                </div>
                                <div class="slide-images">
                                    <a href="service-details.html">
                            ...
                            <div class="fav-item d-flex align-items-center justify-content-between w-100">
                                <a href="javascript:void(0);" class="avatar avatar-md">
                                    <img src="<?php echo e(asset('front/assets/img/profiles/avatar-04.jpg')); ?>" class="rounded-circle" alt="User">
                                </a>
                                <a href="javascript:void(0);" class="fav-icon">
                                    <i class="ti ti-heart"></i>
                                </a>
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="0.2s">
                        <div class="service-img">
                            <div class="img-slider owl-carousel nav-center">
                                <div class="slide-images">
                                    <a href="service-details.html">
                                        <img src="<?php echo e(asset('front/assets/img/services/service-22.jpg')); ?>" class="img-fluid" alt="img">
                                    </a>
                                </div>
                                <div class="slide-images">
                                    <a href="service-details.html">
                            ...
                            <div class="fav-item d-flex align-items-center justify-content-between w-100">
                                <a href="javascript:void(0);" class="avatar avatar-md">
                                    <img src="<?php echo e(asset('front/assets/img/profiles/avatar-05.jpg')); ?>" class="rounded-circle" alt="User">
                                </a>
                                <a href="javascript:void(0);" class="fav-icon">
                                    <i class="ti ti-heart"></i>
                                </a>
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="0.2s">
                        <div class="service-img">
                            <div class="img-slider owl-carousel nav-center">
                                <div class="slide-images">
                                    <a href="service-details.html">
                                        <img src="<?php echo e(asset('front/assets/img/services/service-13.jpg')); ?>" class="img-fluid" alt="img">
                                    </a>
                                </div>
                                <div class="slide-images">
                                    <a href="service-details.html">
                                        <img src="<?php echo e(asset('front/assets/img/services/service-14.jpg')); ?>" class="img-fluid" alt="img">
                                    </a>
                                </div>
                                <div class="slide-images">
                                    <a href="service-details.html">
                            ...
                            <div class="fav-item d-flex align-items-center justify-content-between w-100">
                                <a href="javascript:void(0);" class="avatar avatar-md">
                                    <img src="<?php echo e(asset('front/assets/img/profiles/avatar-01.jpg')); ?>" class="rounded-circle" alt="User">
                                </a>
                                <a href="javascript:void(0);" class="fav-icon">
                                    <i class="ti ti-heart"></i>
                                </a>
                ...
                <div class="feature-slider owl-carousel nav-center">
                    <div class="service-item">
                        <div class="service-img">
                            ...
                            <div class="fav-item d-flex align-items-center justify-content-between w-100">
                                <a href="javascript:void(0);" class="avatar avatar-md">
                                    <img src="<?php echo e(asset('front/assets/img/profiles/avatar-11.jpg')); ?>" class="rounded-circle" alt="User">
                                </a>
                                <a href="javascript:void(0);" class="fav-icon">
                                    <i class="ti ti-heart"></i>
                                </a>
                    ...
                    <div class="service-item">
                        <div class="service-img">
                            ...
                            <div class="fav-item d-flex align-items-center justify-content-between w-100">
                                <a href="javascript:void(0);" class="avatar avatar-md">
                                    <img src="<?php echo e(asset('front/assets/img/profiles/avatar-12.jpg')); ?>" class="rounded-circle" alt="User">
                                </a>
                                <a href="javascript:void(0);" class="fav-icon">
                                    <i class="ti ti-heart"></i>
                                </a>
                    ...
                    <div class="service-item">
                        <div class="service-img">
                            ...
                            <div class="fav-item d-flex align-items-center justify-content-between w-100">
                                <a href="javascript:void(0);" class="avatar avatar-md">
                                    <img src="<?php echo e(asset('front/assets/img/profiles/avatar-17.jpg')); ?>" class="rounded-circle" alt="User">
                                </a>
                                <a href="javascript:void(0);" class="fav-icon">
                                    <i class="ti ti-heart"></i>
                                </a>
                    ...
                    <div class="service-item">
                        <div class="service-img">
                            <div class="img-slider owl-carousel nav-center">
                                <div class="slide-images">
                                    <a href="service-details.html">
                                        <img src="<?php echo e(asset('front/assets/img/services/service-54.jpg')); ?>" class="img-fluid" alt="img">
                                    </a>
                                </div>
                                <div class="slide-images">
                                    <a href="service-details.html">
                            ...
                            <div class="fav-item d-flex align-items-center justify-content-between w-100">
                                <a href="javascript:void(0);" class="avatar avatar-md">
                                    <img src="<?php echo e(asset('front/assets/img/profiles/avatar-08.jpg')); ?>" class="rounded-circle" alt="User">
                                </a>
                                <a href="javascript:void(0);" class="fav-icon">
                                    <i class="ti ti-heart"></i>
                                </a>
                    ...
                    <div class="service-item">
                        <div class="service-img">
                            <div class="img-slider owl-carousel nav-center">
                                <div class="slide-images">
                                    <a href="service-details.html">
                                        <img src="<?php echo e(asset('front/assets/img/services/service-56.jpg')); ?>" class="img-fluid" alt="img">
                                    </a>
                                </div>
                                <div class="slide-images">
                                    <a href="service-details.html">
                            ...
                            <div class="fav-item d-flex align-items-center justify-content-between w-100">
                                <a href="javascript:void(0);" class="avatar avatar-md">
                                    <img src="<?php echo e(asset('front/assets/img/profiles/avatar-14.jpg')); ?>" class="rounded-circle" alt="User">
                                </a>
                                <a href="javascript:void(0);" class="fav-icon">
                                    <i class="ti ti-heart"></i>
                                </a>
                    ...
                    <div class="service-item">
                        <div class="service-img">
                            <div class="img-slider owl-carousel nav-center">
                                <div class="slide-images">
                                    <a href="service-details.html">
                                        <img src="<?php echo e(asset('front/assets/img/services/service-62.jpg')); ?>" class="img-fluid" alt="img">
                                    </a>
                                </div>
                                <div class="slide-images">
                                    <a href="service-details.html">
                            ...
                            <div class="fav-item d-flex align-items-center justify-content-between w-100">
                                <a href="javascript:void(0);" class="avatar avatar-md">
                                    <img src="<?php echo e(asset('front/assets/img/profiles/avatar-16.jpg')); ?>" class="rounded-circle" alt="User">
                                </a>
                                <a href="javascript:void(0);" class="fav-icon">
                                    <i class="ti ti-heart"></i>
                                </a>
                    ...
                    <div class="service-item">
                        <div class="service-img">
                            <div class="img-slider owl-carousel nav-center">
                                <div class="slide-images">
                                    <a href="service-details.html">
                                        <img src="<?php echo e(asset('front/assets/img/services/service-59.jpg')); ?>" class="img-fluid" alt="img">
                                    </a>
                                </div>
                                <div class="slide-images">
                                    <a href="service-details.html">
                            ...
                            <div class="fav-item d-flex align-items-center justify-content-between w-100">
                                <a href="javascript:void(0);" class="avatar avatar-md">
                                    <img src="<?php echo e(asset('front/assets/img/profiles/avatar-19.jpg')); ?>" class="rounded-circle" alt="User">
                                </a>
                                <a href="javascript:void(0);" class="fav-icon">
                                    <i class="ti ti-heart"></i>
                                </a>
                ...
                <div class="feature-slider owl-carousel nav-center">
                    <div class="service-item">
                        <div class="service-img">
                            <div class="img-slider owl-carousel nav-center">
                                <div class="slide-images">
                                    <a href="service-details.html">
                                        <img src="<?php echo e(asset('front/assets/img/services/service-23.jpg')); ?>" class="img-fluid" alt="img">
                                    </a>
                                </div>
                                <div class="slide-images">
                                    <a href="service-details.html">
                    ...
                    <div class="service-item">
                        <div class="service-img">
                            ...
                            <div class="fav-item d-flex align-items-center justify-content-between w-100">
                                <a href="javascript:void(0);" class="avatar avatar-md">
                                    <img src="<?php echo e(asset('front/assets/img/profiles/avatar-06.jpg')); ?>" class="rounded-circle" alt="User">
                                </a>
                                <a href="javascript:void(0);" class="fav-icon">
                                    <i class="ti ti-heart"></i>
                                </a>
                    ...
                    <div class="service-item">
                        <div class="service-img">
                            <div class="img-slider owl-carousel nav-center">
                                <div class="slide-images">
                                    <a href="service-details.html">
                                        <img src="<?php echo e(asset('front/assets/img/services/service-63.jpg')); ?>" class="img-fluid" alt="img">
                                    </a>
                                </div>
                                <div class="slide-images">
                                    <a href="service-details.html">
                    ...
                    <div class="service-item">
                        <div class="service-img">
                            <div class="img-slider owl-carousel nav-center">
                                <div class="slide-images">
                                    <a href="service-details.html">
                                        <img src="<?php echo e(asset('front/assets/img/services/service-60.jpg')); ?>" class="img-fluid" alt="img">
                                    </a>
                                </div>
                                <div class="slide-images">
                                    <a href="service-details.html">
                            ...
                            <div class="fav-item d-flex align-items-center justify-content-between w-100">
                                <a href="javascript:void(0);" class="avatar avatar-md">
                                    <img src="<?php echo e(asset('front/assets/img/profiles/avatar-15.jpg')); ?>" class="rounded-circle" alt="User">
                                </a>
                                <a href="javascript:void(0);" class="fav-icon">
                                    <i class="ti ti-heart"></i>
                                </a>
                    ...
                    <div class="service-item">
                        <div class="service-img">
                            <div class="img-slider owl-carousel nav-center">
                                <div class="slide-images">
                                    <a href="service-details.html">
                                        <img src="<?php echo e(asset('front/assets/img/services/service-55.jpg')); ?>" class="img-fluid" alt="img">
                                    </a>
                                </div>
                                <div class="slide-images">
                                    <a href="service-details.html">
                            ...
                            <div class="fav-item d-flex align-items-center justify-content-between w-100">
                                <a href="javascript:void(0);" class="avatar avatar-md">
                                    <img src="<?php echo e(asset('front/assets/img/profiles/avatar-13.jpg')); ?>" class="rounded-circle" alt="User">
                                </a>
                                <a href="javascript:void(0);" class="fav-icon">
                                    <i class="ti ti-heart"></i>
                                </a>
                    ...
                    <div class="service-item">
                        <div class="service-img">
                            <div class="img-slider owl-carousel nav-center">
                                <div class="slide-images">
                                    <a href="service-details.html">
                                        <img src="<?php echo e(asset('front/assets/img/services/service-51.jpg')); ?>" class="img-fluid" alt="img">
                                    </a>
                                </div>
                                <div class="slide-images">
                                    <a href="service-details.html">
                            ...
                            <div class="fav-item d-flex align-items-center justify-content-between w-100">
                                <a href="javascript:void(0);" class="avatar avatar-md">
                                    <img src="<?php echo e(asset('front/assets/img/profiles/avatar-18.jpg')); ?>" class="rounded-circle" alt="User">
                                </a>
                                <a href="javascript:void(0);" class="fav-icon">
                                    <i class="ti ti-heart"></i>
                                </a>
                    ...
                    <div class="service-item">
                        <div class="service-img">
                            <div class="img-slider owl-carousel nav-center">
                                <div class="slide-images">
                                    <a href="service-details.html">
                                        <img src="<?php echo e(asset('front/assets/img/services/service-58.jpg')); ?>" class="img-fluid" alt="img">
                                    </a>
                                </div>
                                <div class="slide-images">
                                    <a href="service-details.html">
                    ...
                    <div class="service-item">
                        <div class="service-img">
                            <div class="img-slider owl-carousel nav-center">
                                <div class="slide-images">
                                    <a href="service-details.html">
                                        <img src="<?php echo e(asset('front/assets/img/services/service-61.jpg')); ?>" class="img-fluid" alt="img">
                                    </a>
                                </div>
                                <div class="slide-images">
                                    <a href="service-details.html">
...
<section class="section pt-0">
    <div class="container">
        <div class="work-section bg-black m-0">
            ...
            <div class="row gx-0 gy-4">
                <div class="col-lg-4 d-flex">
                    <div class="work-item text-center flex-fill">
                        <div class="mb-3">
                            <img src="<?php echo e(asset('front/assets/img/icons/work-01.svg')); ?>" alt="img">
                        </div>
                ...
                <div class="col-lg-4 d-flex">
                    <div class="work-item work-03 text-center flex-fill">
                        <div class="mb-3">
                            <img src="<?php echo e(asset('front/assets/img/icons/work-03.svg')); ?>" alt="img">
                        </div>
            ...
            <div class="work-bg1">
                <img src="<?php echo e(asset('front/assets/img/bg/work-bg-01.svg')); ?>" class="img-fluid" alt="img">
            </div>
            <div class="work-bg2">
                <img src="<?php echo e(asset('front/assets/img/bg/work-bg-02.svg')); ?>" class="img-fluid" alt="img">
            </div>
        </div>
    </div>
</section>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        <a href="provider-details.html" class="d-flex align-items-center mb-2 service-pro-info">
                            <span class="avatar avatar-sm me-2">
                                <img src="<?php echo e(asset('front/assets/img/profiles/avatar-05.jpg')); ?>" alt="img"
            ...
            <div class="service-item">
                <div class="service-img">
                    <div class="img-slider owl-carousel nav-center">
                        <div class="slide-images">
                            <a href="service-details.html">
                                <img src="<?php echo e(asset('front/assets/img/services/service-24.jpg')); ?>" class="img-fluid" alt="img">
                            </a>
                        </div>
                        <div class="slide-images">
                            <a href="service-details.html">
                ...
                <div class="service-content">
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        <a href="provider-details.html" class="d-flex align-items-center mb-2 service-pro-info">
                            <span class="avatar avatar-sm me-2">
                                <img src="<?php echo e(asset('front/assets/img/profiles/avatar-17.jpg')); ?>" alt="img"
                                    class="img-fluid rounded-circle">
                            </span>
            ...
            <div class="service-item">
                <div class="service-img">
                    <div class="img-slider owl-carousel nav-center">
                        <div class="slide-images">
                            <a href="service-details.html">
                                <img src="<?php echo e(asset('front/assets/img/services/service-25.jpg')); ?>" class="img-fluid" alt="img">
                            </a>
                        </div>
                        <div class="slide-images">
                            <a href="service-details.html">
                ...
                <div class="service-content">
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        <a href="provider-details.html" class="d-flex align-items-center mb-2 service-pro-info">
                            <span class="avatar avatar-sm me-2">
                                <img src="<?php echo e(asset('front/assets/img/profiles/avatar-16.jpg')); ?>" alt="img"
                                    class="img-fluid rounded-circle">
                            </span>
            ...
            <div class="service-item">
                <div class="service-img">
                    <div class="img-slider owl-carousel nav-center">
                        <div class="slide-images">
                            <a href="service-details.html">
                                <img src="<?php echo e(asset('front/assets/img/services/service-50.jpg')); ?>" class="img-fluid" alt="img">
                            </a>
                        </div>
                        <div class="slide-images">
                            <a href="service-details.html">
                ...
                <div class="service-content">
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        <a href="provider-details.html" class="d-flex align-items-center mb-2 service-pro-info">
                            <span class="avatar avatar-sm me-2">
                                <img src="<?php echo e(asset('front/assets/img/profiles/avatar-06.jpg')); ?>" alt="img"
                                    class="img-fluid rounded-circle">
                            </span>
            ...
            <div class="service-item">
                <div class="service-img">
                    <div class="img-slider owl-carousel nav-center">
                        <div class="slide-images">
                            <a href="service-details.html">
                                <img src="<?php echo e(asset('front/assets/img/services/service-47.jpg')); ?>" class="img-fluid" alt="img">
                            </a>
                        </div>
                        <div class="slide-images">
                            <a href="service-details.html">
                                <img src="<?php echo e(asset('front/assets/img/services/service-48.jpg')); ?>" class="img-fluid" alt="img">
                            </a>
                        </div>
                        <div class="slide-images">
                            <a href="service-details.html">
                                <img src="<?php echo e(asset('front/assets/img/services/service-49.jpg')); ?>" class="img-fluid" alt="img">
                            </a>
                        </div>
                    </div>
                    <div class="fav-item">
                ...
                <div class="service-content">
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        <a href="provider-details.html" class="d-flex align-items-center mb-2 service-pro-info">
                            <span class="avatar avatar-sm me-2">
                                <img src="<?php echo e(asset('front/assets/img/profiles/avatar-09.jpg')); ?>" alt="img"
                                    class="img-fluid rounded-circle">
                            </span>
            ...
            <div class="service-item">
                ...
                <div class="service-content">
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        <a href="provider-details.html" class="d-flex align-items-center mb-2 service-pro-info">
                            <span class="avatar avatar-sm me-2">
                                <img src="<?php echo e(asset('front/assets/img/profiles/avatar-25.jpg')); ?>" alt="img"
                                    class="img-fluid rounded-circle">
                            </span>
            ...
            <div class="row gx-0">
                    ...
                    <div class="provider-item flex-fill">
                        <div class="d-flex align-items-center">
                            <a href="provider-details.html" class="avatar avatar-xl me-2">
                                <img src="<?php echo e(asset('front/assets/img/profiles/avatar-18.jpg')); ?>" alt="img" class="rounded-circle">
                            </a>
                            <div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 d-flex">
                    <div class="provider-item flex-fill">
                        <div class="d-flex align-items-center">
                            <a href="provider-details.html" class="avatar avatar-xl me-2">
                                <img src="<?php echo e(asset('front/assets/img/profiles/avatar-07.jpg')); ?>" alt="img" class="rounded-circle">
                            </a>
                            <div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 d-flex">
                    <div class="provider-item flex-fill">
                        <div class="d-flex align-items-center">
                            <a href="provider-details.html" class="avatar avatar-xl me-2">
                                <img src="<?php echo e(asset('front/assets/img/profiles/avatar-08.jpg')); ?>" alt="img" class="rounded-circle">
                            </a>
                            <div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 d-flex">
                    <div class="provider-item flex-fill">
                        <div class="d-flex align-items-center">
                            <a href="provider-details.html" class="avatar avatar-xl me-2">
                                <img src="<?php echo e(asset('front/assets/img/profiles/avatar-09.jpg')); ?>" alt="img" class="rounded-circle">
                            </a>
                            <div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 d-flex">
                    <div class="provider-item flex-fill">
                        <div class="d-flex align-items-center">
                            <a href="provider-details.html" class="avatar avatar-xl me-2">
                                <img src="<?php echo e(asset('front/assets/img/profiles/avatar-19.jpg')); ?>" alt="img" class="rounded-circle">
                            </a>
                            <div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 d-flex">
                    <div class="provider-item flex-fill">
                        <div class="d-flex align-items-center">
                            <a href="provider-details.html" class="avatar avatar-xl me-2">
                                <img src="<?php echo e(asset('front/assets/img/profiles/avatar-11.jpg')); ?>" alt="img" class="rounded-circle">
                            </a>
                            <div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 d-flex">
                    <div class="provider-item flex-fill">
                        <div class="d-flex align-items-center">
                            <a href="provider-details.html" class="avatar avatar-xl me-2">
                                <img src="<?php echo e(asset('front/assets/img/profiles/avatar-12.jpg')); ?>" alt="img" class="rounded-circle">
                            </a>
                            <div>
        ...
        <div class="tab-content">
                ...
                <div class="row g-4">
                    <div class="col-md-6 col-lg-3">
                        <a href="service-details.html" class="rated-wrap">
                            <img src="<?php echo e(asset('front/assets/img/services/rated-service-05.jpg')); ?>" alt="img" class="img-fluid">
                            <h6 class="text-white">Laser Tattoo Removal</h6>
                        </a>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <a href="service-details.html" class="rated-wrap">
                            <img src="<?php echo e(asset('front/assets/img/services/rated-service-06.jpg')); ?>" alt="img" class="img-fluid">
                            <h6 class="text-white">Surgical Excision</h6>
                        </a>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <a href="service-details.html" class="rated-wrap">
                            <img src="<?php echo e(asset('front/assets/img/services/rated-service-07.jpg')); ?>" alt="img" class="img-fluid">
                            <h6 class="text-white">Saline Tattoo Removal</h6>
                        </a>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <a href="service-details.html" class="rated-wrap">
                            <img src="<?php echo e(asset('front/assets/img/services/rated-service-08.jpg')); ?>" alt="img" class="img-fluid">
            ...
            <div class="tab-pane fade" id="rate-furniture">
                <div class="row g-4">
                    <div class="col-md-6 col-lg-3">
                        <a href="service-details.html" class="rated-wrap">
                            <img src="<?php echo e(asset('front/assets/img/services/rated-service-09.jpg')); ?>" alt="img" class="img-fluid">
                            <h6 class="text-white">Home Furniture Assembly</h6>
                        </a>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <a href="service-details.html" class="rated-wrap">
                            <img src="<?php echo e(asset('front/assets/img/services/rated-service-10.jpg')); ?>" alt="img" class="img-fluid">
                            <h6 class="text-white">Office Furniture Assembly</h6>
                        </a>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <a href="service-details.html" class="rated-wrap">
                            <img src="<?php echo e(asset('front/assets/img/services/rated-service-11.jpg')); ?>" alt="img" class="img-fluid">
                            <h6 class="text-white">Fitness Equipment Assembly</h6>
                        </a>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <a href="service-details.html" class="rated-wrap">
                            <img src="<?php echo e(asset('front/assets/img/services/rated-service-12.jpg')); ?>" alt="img" class="img-fluid">
            ...
            <div class="tab-pane fade show active" id="rate-electrical">
                <div class="row g-4">
                    <div class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.2s">
                        <a href="service-details.html" class="rated-wrap">
                            <img src="<?php echo e(asset('front/assets/img/services/rated-service-01.jpg')); ?>" alt="img" class="img-fluid">
                            <h6 class="text-white">Wiring and rewiring</h6>
                        </a>
                    </div>
                    <div class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.4s">
                        <a href="service-details.html" class="rated-wrap">
                            <img src="<?php echo e(asset('front/assets/img/services/rated-service-02.jpg')); ?>" alt="img" class="img-fluid">
                            <h6 class="text-white">Ceiling fan installation</h6>
                        </a>
                    </div>
                    <div class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.6s">
                        <a href="service-details.html" class="rated-wrap">
                            <img src="<?php echo e(asset('front/assets/img/services/rated-service-03.jpg')); ?>" alt="img" class="img-fluid">
                            <h6 class="text-white">Faulty wiring repair</h6>
                        </a>
                    </div>
                    <div class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.8s">
                        <a href="service-details.html" class="rated-wrap">
                            <img src="<?php echo e(asset('front/assets/img/services/rated-service-04.jpg')); ?>" alt="img" class="img-fluid">
            ...
            <div class="tab-pane fade" id="rate-construction">
                <div class="row g-4">
                    <div class="col-md-6 col-lg-3">
                        <a href="service-details.html" class="rated-wrap">
                            <img src="<?php echo e(asset('front/assets/img/services/rated-service-13.jpg')); ?>" alt="img" class="img-fluid">
                            <h6 class="text-white">Residential Construction</h6>
                        </a>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <a href="service-details.html" class="rated-wrap">
                            <img src="<?php echo e(asset('front/assets/img/services/rated-service-14.jpg')); ?>" alt="img" class="img-fluid">
                            <h6 class="text-white">Roofing Services</h6>
                        </a>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <a href="service-details.html" class="rated-wrap">
                            <img src="<?php echo e(asset('front/assets/img/services/rated-service-15.jpg')); ?>" alt="img" class="img-fluid">
                            <h6 class="text-white">Commercial Construction</h6>
                        </a>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <a href="service-details.html" class="rated-wrap">
                            <img src="<?php echo e(asset('front/assets/img/services/rated-service-16.jpg')); ?>" alt="img" class="img-fluid">
            ...
            <div class="tab-pane fade" id="rate-man">
                <div class="row g-4">
                    <div class="col-md-6 col-lg-3">
                        <a href="service-details.html" class="rated-wrap">
                            <img src="<?php echo e(asset('front/assets/img/services/rated-service-17.jpg')); ?>" alt="img" class="img-fluid">
                            <h6 class="text-white">Local Moves</h6>
                        </a>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <a href="service-details.html" class="rated-wrap">
                            <img src="<?php echo e(asset('front/assets/img/services/rated-service-18.jpg')); ?>" alt="img" class="img-fluid">
                            <h6 class="text-white">Furniture Delivery</h6>
                        </a>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <a href="service-details.html" class="rated-wrap">
                            <img src="<?php echo e(asset('front/assets/img/services/rated-service-19.jpg')); ?>" alt="img" class="img-fluid">
                            <h6 class="text-white">House Clearance</h6>
                        </a>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <a href="service-details.html" class="rated-wrap">
                            <img src="<?php echo e(asset('front/assets/img/services/rated-service-20.jpg')); ?>" alt="img" class="img-fluid">
            ...
            <div class="tab-pane fade" id="rate-plumbing">
                <div class="row g-4">
                    <div class="col-md-6 col-lg-3">
                        <a href="service-details.html" class="rated-wrap">
                            <img src="<?php echo e(asset('front/assets/img/services/rated-service-21.jpg')); ?>" alt="img" class="img-fluid">
                            <h6 class="text-white">Water Filtration</h6>
                        </a>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <a href="service-details.html" class="rated-wrap">
                            <img src="<?php echo e(asset('front/assets/img/services/rated-service-22.jpg')); ?>" alt="img" class="img-fluid">
                            <h6 class="text-white">Emergency Plumbing Repairs</h6>
                        </a>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <a href="service-details.html" class="rated-wrap">
                            <img src="<?php echo e(asset('front/assets/img/services/rated-service-23.jpg')); ?>" alt="img" class="img-fluid">
                            <h6 class="text-white">Drain Cleaning</h6>
                        </a>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <a href="service-details.html" class="rated-wrap">
                            <img src="<?php echo e(asset('front/assets/img/services/rated-service-24.jpg')); ?>" alt="img" class="img-fluid">
    ...
    <div class="container">
        ...
        <div class="testimonial-slider owl-carousel nav-center">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center overflow-hidden">
                        <span class="avatar avatar-lg flex-shrink-0">
                            <img src="<?php echo e(asset('front/assets/img/profiles/avatar-14.jpg')); ?>" class="img-fluid rounded-circle" alt="img">
                        </span>
            ...
            <div class="testimonial-item wow fadeInUp" data-wow-delay="0.2s">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center overflow-hidden">
                        <span class="avatar avatar-lg flex-shrink-0">
                            <img src="<?php echo e(asset('front/assets/img/profiles/avatar-15.jpg')); ?>" class="img-fluid rounded-circle" alt="img">
                        </span>
            ...
            <div class="testimonial-item wow fadeInUp" data-wow-delay="0.2s">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center overflow-hidden">
                        <span class="avatar avatar-lg flex-shrink-0">
                            <img src="<?php echo e(asset('front/assets/img/profiles/avatar-13.jpg')); ?>" class="img-fluid rounded-circle" alt="img">
                        </span>
            ...
            <div class="testimonial-item wow fadeInUp" data-wow-delay="0.2s">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center overflow-hidden">
                        <span class="avatar avatar-lg flex-shrink-0">
                            <img src="<?php echo e(asset('front/assets/img/profiles/avatar-12.jpg')); ?>" class="img-fluid rounded-circle" alt="img">
                        </span>
        ...
        <div class="text-center wow fadeInUp" data-wow-delay="0.2s">
            ...
            <p>
                ...
                <img src="<?php echo e(asset('front/assets/img/icons/star-01.svg')); ?>" class="img-fluid" alt="img">
                <img src="<?php echo e(asset('front/assets/img/icons/star-01.svg')); ?>" class="img-fluid" alt="img">
                <img src="<?php echo e(asset('front/assets/img/icons/star-01.svg')); ?>" class="img-fluid" alt="img">
                <img src="<?php echo e(asset('front/assets/img/icons/star-01.svg')); ?>" class="img-fluid" alt="img">
                <img src="<?php echo e(asset('front/assets/img/icons/star-01.svg')); ?>" class="img-fluid" alt="img">
...
<section class="section provide-section bg-black">
    ...
    <div class="provider-bg1">
        <img src="<?php echo e(asset('front/assets/img/bg/provide-bg-01.svg')); ?>" class="img-fluid" alt="img">
    </div>
    <div class="provider-bg2">
        <img src="<?php echo e(asset('front/assets/img/bg/provide-bg-02.svg')); ?>" class="img-fluid" alt="img">
    </div>
</section>
<!-- /Provider Section -->
...
<section class="section blog-section">
    <div class="container">
            ...
            <div class="blog-item wow fadeInUp" data-wow-delay="0.2s">
                <div class="blog-img">
                    <a href="<?php echo e(route('blog_details', [$blog->slug])); ?>">
                        <img src="<?php echo e(asset('blog/'.$blog->image)); ?>" alt="<?php echo e($blog->title); ?>" onerror="this.onerror=null;this.src='<?php echo e(asset('images/demo.png')); ?>';" class="img-fluid">
                    </a>
                </div>
                <div class="blog-content">
                    <p class="fs-14 fw-meium text-gray-9 d-inline-flex align-items-center mb-2">Admin<i
                            class="ti ti-circle-filled fs-6 mx-1"></i><?php echo e(\Carbon\Carbon::parse($blog->created_at)->format('d M, Y')); ?></p>
                    <h6 class="text-truncate mb-2"><a href="<?php echo e(route('blog_details', [$blog->slug])); ?>"><?php echo e(Str::limit($blog->title, 50, '...')); ?></a>
                    </h6>
                    <p class="two-line-ellipsis mb-3"><?php echo e(Str::limit($blog->title, 100, '...')); ?></p>
                    <div class="d-flex align-items-center flex-wrap">
                        <span class="badge badge-info-transparent me-2"><?php echo e($blog->category->name); ?></span>
                    </div>
                </div>
            </div>
        ...
        <div class="text-center wow fadeInUp" data-wow-delay="0.2s">
            <a href="<?php echo e(url('blogs')); ?>" class="btn btn-dark">View All<i class="ti ti-arrow-right ms-2"></i></a>
        </div>
    </div>
</section>
<!-- / Blog Section -->
        ...
        <div class="row align-items-center bg-01">
            ...
            <div class="col-md-6 text-md-end wow fadeInUp" data-wow-delay="0.2s">
                <div class="business-img">
                    <img src="<?php echo e(asset('front/assets/img/business.jpg')); ?>" class="img-fluid" alt="img">
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app_front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\sgitsss\guddu\resources\views/home.blade.php ENDPATH**/ ?>