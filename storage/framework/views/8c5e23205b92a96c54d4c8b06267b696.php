<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-header border-bottom d-flex justify-content-between">
            ...
            <a href="<?php echo e(route('blog_create')); ?>" class="btn add-new btn-primary"><span><span
...
<?php $__env->startPush('scripts'); ?>
    <script>
        $(document).ready(function() {
            ...
            const table1 = initializeDataTable("#data-table", "<?php echo e(route('blog_list')); ?>", Columns, function (d) {
        ...
        function deleteBlog(Id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    let url = "<?php echo e(route('blog_destroy', ':id')); ?>".replace(':id', Id);
        ...
        function openModal(type, value) {
            ...
            if (type === 'image') {
                content = `<img src="<?php echo e(asset('blog')); ?>/${value}" alt="Image" class="img-fluid" style="width: 100%;">`;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\sgitsss\ignitingbusiness\resources\views/blog/view.blade.php ENDPATH**/ ?>