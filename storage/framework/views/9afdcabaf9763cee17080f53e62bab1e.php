      ...
      <div class="card mb-6">
        ...
        <div class="user-profile-header d-flex flex-column flex-lg-row text-sm-start text-center mb-5">
          <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
            <img src="<?php echo e(asset('profile_images/'.$user->image)); ?>" onerror="this.onerror=null;this.src='<?php echo e($def); ?>';" alt="user image" class="d-block h-auto ms-0 ms-sm-6 rounded user-profile-img" />
          </div>
        ...
        <div class="card-body">
          ...
          <ul class="list-unstyled my-3 py-1">
            <li class="d-flex align-items-center mb-4">
              ...
              ><span class="fw-medium mx-2">Full Name:</span> <span><?php echo e($user->name); ?></span>
            </li>
            <li class="d-flex align-items-center mb-4">
            ...
            <li class="d-flex align-items-center mb-4">
              ...
              <span><?php echo e($user->address->country->name); ?></span>
            </li>

            <li class="d-flex align-items-center mb-4">
              <i class="icon-base ti tabler-world icon-lg"></i><span class="fw-medium mx-2">State:</span>
              <span><?php echo e($user->address->state->name); ?></span>
            </li>


            <li class="d-flex align-items-center mb-4">
              <i class="icon-base ti tabler-world icon-lg"></i><span class="fw-medium mx-2">City:</span>
              <span><?php echo e($user->address->city->name); ?></span>
            </li>


            <li class="d-flex align-items-center mb-2">
              <i class="icon-base ti tabler-world icon-lg"></i
              ><span class="fw-medium mx-2">Address:</span> <span><?php echo e($user->address->address); ?>,<?php echo e($user->address->zip); ?></span>
            </li>
          </ul>
        ...
        <div class="card-body">
          ...
          <ul class="list-unstyled my-3 py-1">
            <li class="d-flex align-items-center mb-4">
              ...
              <span><?php echo e($user->kyc->address_proof_type); ?></span>
            </li>
            <li class="d-flex align-items-center mb-4">
              <i class="icon-base ti tabler-messages icon-lg"></i
              ><span class="fw-medium mx-2">Number:</span> <span><?php echo e($user->kyc->id_proof_no); ?></span>
            </li>

            <li class="d-flex align-items-center mb-4">
              <i class="icon-base ti tabler-mail icon-lg"></i><span class="fw-medium mx-2">Image:</span>
              <br>
              <img src="<?php echo e(asset('identification_images/'.$user->kyc->id_proof_img)); ?>" alt="" width="100%" height="200px">
            </li>
          </ul>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\sgitsss\ignitingbusiness\resources\views/users_list/single.blade.php ENDPATH**/ ?>