<?php $__env->startSection('content'); ?>
                            ...
                            <div class="mb-6">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control" id="search-title"
                                        placeholder="Search By Title" aria-label="Course Title"
    ...
    <div class="card">
        <div class="card-header border-bottom d-flex justify-content-between">
            ...
            <a href="<?php echo e(route('add_course')); ?>" class="btn add-new btn-primary"><span><span
...
<?php $__env->startPush('scripts'); ?>
    ...
    $(document).ready(function() {
        ...
        const table1 = initializeDataTable('#data-table', '<?php echo e(route('course_list')); ?>', businessColumns, function (d) {
            d.name = $('#search-name').val();
            d.status = $('#status').val();
        });

        $('#search-title, #status').on('change keyup', function () {
            table1.draw();
        });
    ...
    function deleteCourses(courseId) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let url = "<?php echo e(route('status_course', ':id')); ?>".replace(':id', courseId);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\sgitsss\ignitingbusiness\resources\views/courses/courses/view.blade.php ENDPATH**/ ?>