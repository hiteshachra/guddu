        ...
        <div class="row mb-6 gy-6">
            ...
            <div class="col-xl">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="editCourse" action="<?php echo e(route('add_course')); ?>" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <select class="form-select" id="category" name="category"
                                            ...
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($category->id); ?>" <?php if(old('category',$course->id) == $category->id): echo 'selected'; endif; ?>>
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" class="form-control" id="title" name="title"
                                                ...
                                                value="<?php echo e(old('title',$course->title)); ?>" aria-describedby="title2" />
                                        </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="mb-6">
                                        ...
                                        <select class="form-select" id="file_type" name="file_type"
                                            ...
                                            <option value="pdf" <?php if(old('file_type',$course->file_type) == 'pdf'): echo 'selected'; endif; ?>>PDF</option>
                                            <option value="pdf_url" <?php if(old('file_type',$course->file_type) == 'pdf_url'): echo 'selected'; endif; ?>>PDF URL</option>
                                            <option value="video" <?php if(old('file_type',$course->file_type) == 'video'): echo 'selected'; endif; ?>>Video</option>
                                            <option value="video_url" <?php if(old('file_type',$course->file_type) == 'video_url'): echo 'selected'; endif; ?>>Video URL</option>
                                        </select>
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="path" name="path"
                                                ...
                                                value="<?php echo e(old('path',$course->path)); ?>" aria-describedby="path2" />
                                        </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="mb-6">
                                        <label class="form-label" for="description">Description<span class="text-danger">*</span>
                                            <span class="text-danger">*</span></label>
                                        <div id="full-editor">
                                            <?php echo old('description',$course->description); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\sgitsss\ignitingbusiness\resources\views/courses/courses/edit.blade.php ENDPATH**/ ?>