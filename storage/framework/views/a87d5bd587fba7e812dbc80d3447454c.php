<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-header border-bottom d-flex justify-content-between">
            ...
            <a href="<?php echo e(route('add_document_type')); ?>" class="btn add-new btn-primary"><span><span
                        class="d-flex align-items-center gap-2"><i class="icon-base ti tabler-plus icon-xs"></i> <span
                            class="d-none d-sm-inline-block">Add Document Type</span></span></span></a>
        </div>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        $(document).ready(function() {
            ...
            const table1 = initializeDataTable("#data-table", "<?php echo e(route('document_type_list')); ?>", Columns, function (d) {
                d.status = $('#status').val();
            });
        ...
        function deleteType(typeId) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    let url = "<?php echo e(route('status_document_type', ':id')); ?>".replace(':id', typeId);

                    $.ajax({
                        url: url,
                        method: 'GET',
                        success: function(response) {
                            Swal.fire('Deleted!', 'Type status changed.', 'success').then(() => {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\sgitsss\ignitingbusiness\resources\views/Document/Type/view.blade.php ENDPATH**/ ?>