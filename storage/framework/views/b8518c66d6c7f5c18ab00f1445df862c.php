<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-header border-bottom d-flex justify-content-between">
            ...
            <a href="<?php echo e(route('add_package')); ?>" class="btn add-new btn-primary"><span><span
...
<?php $__env->startPush('scripts'); ?>
    <script>
        $(document).ready(function() {
            ...
            const table1 = initializeDataTable("#data-table", "<?php echo e(route('package_list')); ?>", Columns, function (d) {
        ...
        function deletePackage(packageId) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    let url = "<?php echo e(route('status_package', ':id')); ?>".replace(':id', packageId);
        ...
        function openModal(type, value) {
            ...
            if (type === 'image') {
                content = `<img src="<?php echo e(asset('package_images')); ?>/${value}" alt="Image" class="img-fluid">`;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\sgitsss\ignitingbusiness\resources\views/courses/packages/view.blade.php ENDPATH**/ ?>