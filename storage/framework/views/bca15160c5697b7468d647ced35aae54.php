                                    ...
                                    <div class="dropdown-shortcuts-list scrollable-container">
                                        ...
                                        <div class="row row-bordered overflow-visible g-0">
                                            <div class="dropdown-shortcuts-item col">
                                                ...
                                                <a href="<?php echo e(url('dashboard')); ?>" class="stretched-link">Dashboard</a>
                            ...
                            <ul class="menu-inner">
                                ...
                                <?php if(in_array(Auth::user()->role, [1, 2])): ?>
                                    ...
                                    <li class="menu-item">
                                        ...
                                        <ul class="menu-sub">
                                            <li class="menu-item">
                                                <a href="<?php echo e(route('category_list')); ?>" class="menu-link">
                                                    <i class="menu-icon icon-base ti tabler-package"></i>
                                                    <div data-i18n="Categories">Categories</div>
                                                </a>
                                            </li>
                                            <li class="menu-item">
                                                <a href="<?php echo e(route('sub_category_list')); ?>" class="menu-link">
...
<?php /**PATH C:\wamp64\www\sgitsss\guddu\resources\views/layouts/app.blade.php ENDPATH**/ ?>