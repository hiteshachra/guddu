			...
			<div class="col-lg-6 col-md-6 grid-item physics" style="position: absolute; left: 0px; top: 0px;">
				<div class="portfolio_item">
					<div class="portfolio_thumb">
                        <iframe width="100%" height="400" class="rounded-4" src="<?php echo e($value->url); ?>"></iframe>
						<div class="portfolio_content">
							<div class="prot-text">	
								<span><?php echo e($value->title); ?></span>								
								<h3> <a href="javascript:void(0)"> <?php echo e($value->description); ?></a></h3>	
							</div>	
...
<?php echo $__env->make('layouts.app_front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\sgitsss\ignitingbusiness\resources\views/video-list.blade.php ENDPATH**/ ?>