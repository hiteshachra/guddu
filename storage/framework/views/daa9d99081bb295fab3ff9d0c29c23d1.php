                ...
                <a href="<?php echo e(url('/')); ?>" class="app-brand-link">
                  <span class="app-brand-logo demo">
                    <span class="text-primary">
                      <img src="<?php echo e(asset('images/'.config('app.logo'))); ?>" width="60">
                    </span>
                  </span>
                  <span class="app-brand-text demo fw-bold text-primary"><?php echo e(config('app.name')); ?></span>
                </a>
              </div>
...
</html><?php /**PATH C:\wamp64\www\sgitsss\ignitingbusiness\resources\views/layouts/app_auth.blade.php ENDPATH**/ ?>