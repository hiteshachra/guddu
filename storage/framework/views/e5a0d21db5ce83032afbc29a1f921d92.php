<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-header border-bottom d-flex justify-content-between">
            ...
            <a href="<?php echo e(route('add_lead')); ?>" class="btn add-new btn-primary"><span><span
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="assignModalBody">
                        <form action="<?php echo e(route('assign_employee_lead')); ?>" method="post">
                            <?php echo csrf_field(); ?>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="statusBody">
                        <form action="<?php echo e(route('status_lead')); ?>" method="post">
                            <?php echo csrf_field(); ?>
...
<?php $__env->startPush('scripts'); ?>
    <script>    
        $(document).ready(function() {
            ...
            const table1 = initializeDataTable('#data-table', '<?php echo e(route('lead_list')); ?>', Columns, function (d) {
                d.status = $('#status').val();
            });
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\sgitsss\ignitingbusiness\resources\views/CRM/leads/view.blade.php ENDPATH**/ ?>