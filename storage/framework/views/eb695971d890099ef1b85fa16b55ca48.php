            ...
            <div class="col-xl">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Edit (<?php echo e($user->name); ?>)</h5>
                    </div>
                    <div class="card-body">
                        <form action="<?php echo e(route('edit_user', [$type,$user->id])); ?>" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" id="email" name="email" class="form-control"
                                                ...
                                                aria-describedby="email2" required value="<?php echo e(old('email',$user->email)); ?>" />
                                        </div>
    ...
    <?php endif; ?>
     ...
     <script>
        $(document).ready(function(){
            ...
            getCities('<?php echo e($user->address->city_id); ?>','<?php echo e($user->address->city_id); ?>')
        });
    </script>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\sgitsss\ignitingbusiness\resources\views/users_list/edit.blade.php ENDPATH**/ ?>