...
<div class="card">
    <div class="card-header border-bottom d-flex justify-content-between">
        <h5 class="card-title mb-0">User List (<?php echo e(ucfirst($type)); ?>)</h5>

        <a href="<?php echo e(route('add_user', $type)); ?>" class="btn add-new btn-primary"><span><span
                    class="d-flex align-items-center gap-2"><i class="icon-base ti tabler-plus icon-xs"></i> <span
                        class="d-none d-sm-inline-block">Add <?php echo e(ucfirst($type)); ?></span></span></span></a>
    </div>
...
<?php $__env->startPush('scripts'); ?>
    ...
    $(document).ready(function() {
            ...
            const table1 = initializeDataTable("#data-table", "<?php echo e(route('user_list', $type)); ?>", Columns, function (d) {
        ...
        function deleteUser(userId) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    let url = "<?php echo e(route('status_user', ':id')); ?>".replace(':id', userId);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\sgitsss\ignitingbusiness\resources\views/users_list/view.blade.php ENDPATH**/ ?>